...
public class EmployeeRestController {
	...
	public ResponseEntity updateAdmins(@PathVariable String id, @RequestBody Employee employee) {
	...
	public ResponseEntity updateSuser(@PathVariable String id, @RequestBody Employee employee) {
